...
const Increment = () => {
  if (
    isNaN(CalcAquaStore.Workdays) ||
    CalcAquaStore.Workdays === null ||
    CalcAquaStore.Workdays === undefined
  )
    CalcAquaStore.Workdays = 22;
  else CalcAquaStore.Workdays++;
};
...
const Decrement = () => {
  if (
    ...
    CalcAquaStore.Workdays = 22;
  else if (CalcAquaStore.Workdays > 1) CalcAquaStore.Workdays--;
};
  ...
  <form class="space-y-2">
    <div class="flex items-center w-full gap-4 overflow-hidden">
      <button
        ...
        @click="Decrement"
        :disabled="CalcAquaStore.Workdays <= 1"
        type="button"
      >
      ...
      <Field
        v-model="CalcAquaStore.Workdays"
        name="workdays"
